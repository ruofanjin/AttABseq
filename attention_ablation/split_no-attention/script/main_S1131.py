...
if __name__ == "__main__":
    ...
    train_index, val_index = split('../data/S1131.csv', scale=0.1)
    ...
    """Output files."""
    file_loss_min_PCCS = '../output1131/loss_min_result/RECORD.txt'
    file_loss_min_model = '../output1131/loss_min_model/model'
    file_best_pcc_PCCS = '../output1131/best_pcc_result/RECORD.txt'
    file_best_pcc_model = '../output1131/best_pcc_model/model'
    file_best_r2_PCCS = '../output1131/best_r2_result/RECORD.txt'
    file_best_r2_model = '../output1131/best_r2_model/model'
